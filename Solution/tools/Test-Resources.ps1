...
foreach ($match in [regex]::Matches($source, '"((?:Navigation|Field|Button|Language|Home|Dashboard|Contexts|ContextRole|Notes|NoteType|NoteVisibility|Footer|Validation|Message|Identity)_[A-Za-z0-9]+)"')) {
