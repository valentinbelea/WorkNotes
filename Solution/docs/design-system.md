...
- Headerul editorului are în dreapta doar iconurile Minimizează și Închide (note-editor-icon); toate acțiunile editării sunt în footer (note-editor-footer): bara de informații a paragrafului, apoi tipul, contextul și vizibilitatea, starea salvării și Salvează. Nu există butoane dublate între header și footer.
